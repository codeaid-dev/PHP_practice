...
<body>
  ...
  <table>
    ...
    <td>
      ...
      <label><input type="radio" name="pc" value="desktop" <?= $checked == 'desktop' ? 'checked' : '' ?>>デスクトップPC</label>
      <label><input type="radio" name="pc" value="note" <?= $checked == 'note' ? 'checked' : '' ?>>ノートPC</label>
    </td></tr>
    <tr><td>パソコンメーカー：</td>
    <td>
