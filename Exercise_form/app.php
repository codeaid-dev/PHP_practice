...
$sweets = array('puff' => 'Sesame Seed Puff',
                ...
                'ricemeat' => 'Abalone with Marrow and Duck Feet');
...
function process_form($input) {
  ...
  mail('codeaid.lab@gmail.com', 'New Order', $message);
